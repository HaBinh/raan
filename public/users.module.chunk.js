...
var IndexComponent = (function () {
    ...
    IndexComponent.prototype.openModalRemoveAccount = function (user) {
    ...
    IndexComponent.prototype.removeAccount = function () {
        ...
        this.usersService.removeUser(this.remove_user_id).subscribe(function () {
            _this.users = __WEBPACK_IMPORTED_MODULE_8_lodash__["reject"](_this.users, ["id", _this.remove_user_id]);
